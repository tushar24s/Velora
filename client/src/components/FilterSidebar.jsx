...
const FilterSidebar = ({ categories, filters, setFilters, onClear, onCategoryChange }) => {
  ...
  const panel = (
    <div className="shop-hero-card surface-card space-y-6 p-5">
  ...
  return (
    <div className="space-y-4">
      <button
        ...
        className="surface-card flex w-full items-center justify-between px-5 py-4 text-sm font-semibold lg:hidden"
      >
        Filters
