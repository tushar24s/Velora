const makeReviews = (names) =>
  names.map((name, index) => ({
    name,
    rating: index % 2 === 0 ? 5 : 4,
    comment:
      index % 2 === 0
        ? "Excellent finish, clean packaging, and the product looks premium in person."
        : "Feels polished, reliable, and exactly what I expected from the listing.",
  }));
...
const catalog = [
  {
    slug: "burberry-check-cashmere-scarf",
    ...
    specs: [
      ...
      ["Use", "Cold-season layering"],
    ],
  },
  {
    slug: "ray-ban-clubmaster-sunglasses",
    ...
    specs: [
      ["Frame", "Browline acetate-metal"],
      ["Lens", "UV protective"],
      ["Style", "Classic eyewear"],
    ],
  },
  {
    ...
    specs: [
      ...
      ["Layout", "6-card interior"],
      ["Style", "Slim wallet"],
    ],
  },
  {
    slug: "ferragamo-reversible-leather-belt",
    ...
    specs: [
      ...
      ["Feature", "Reversible strap"],
      ["Hardware", "Signature buckle"],
    ],
  },
  {
  ...
  },
  {
    ...
    specs: [
      ["Fabric", "Premium cotton poplin"],
      ["Fit", "Tailored"],
      ["Detail", "Mother-of-pearl buttons"],
    ],
  },
  {
  ...
  },
  {
    ...
    specs: [
      ...
      ["Mood", "Resort dressing"],
      ["Collar", "Open collar"],
    ],
  },
  {
    slug: "mens-premium-overshirt",
  ...
  },
  {
    ...
    specs: [
      ...
      ["Fit", "Oversized"],
      ["Use", "Luxury loungewear"],
    ],
  },
  {
    slug: "womens-satin-midi-dress",
  ...
  },
  {
    ...
    specs: [
      ["Type", "Luxury sneaker"],
      ["Upper", "Suede upper"],
      ["Use", "Refined daily wear"],
    ],
  },
  {
    slug: "puma-casual-sneakers",
    ...
    specs: [
      ["Type", "Chelsea boot"],
      ["Upper", "Polished calf leather"],
      ["Sole", "Leather-rubber combination"],
    ],
  },
  {
    slug: "michael-kors-leather-handbag",
  ...
  },
  {
    ...
    specs: [
      ["Type", "Shoulder bag"],
      ["Finish", "Smooth grain texture"],
      ["Interior", "Zip and slip pockets"],
    ],
  },
  {
    slug: "coach-designer-tote-bag",
  ...
  {
    slug: "michael-kors-jet-set-satchel",
    ...
    specs: [
      ...
      ["Carry", "Top handle + crossbody strap"],
  ...
  },
  {
    ...
    specs: [
      ...
      ["Style", "Classical dress complication"],
    ],
  },
];
...
const products = catalog.map((item, index) => ({
  ...
  specifications: item.specs.map(([label, value]) => ({ label, value })),
  reviews: makeReviews(
    [
      "Rahul",
      "Priya",
